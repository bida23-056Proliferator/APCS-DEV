...
export const SUPABASE_URL      = "https://usafiirpqwekbhuclybn.supabase.co";
...
// Loan calculator — rate scales by amount
export const calcLoan = (principal) => {
  ...
  return { principal: p, rate, interest, total: p + interest };
};